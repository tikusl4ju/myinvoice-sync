...
class LHDN_Helpers {
    ...
    public static function canonical_json($data) {
        return json_encode(
            json_decode(json_encode($data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE), true),
    ...
    public static function get_state_options() {
        return [
            'JH' => ['code' => '01', 'label' => 'Johor'],
            'KD' => ['code' => '02', 'label' => 'Kedah'],
            'KT' => ['code' => '03', 'label' => 'Kelantan'],
            'ML' => ['code' => '04', 'label' => 'Melaka'],
            'NS' => ['code' => '05', 'label' => 'Negeri Sembilan'],
            'PH' => ['code' => '06', 'label' => 'Pahang'],
            'PG' => ['code' => '07', 'label' => 'Pulau Pinang'],
            'PK' => ['code' => '08', 'label' => 'Perak'],
            'PL' => ['code' => '09', 'label' => 'Perlis'],
            'SL' => ['code' => '10', 'label' => 'Selangor'],
            'TR' => ['code' => '11', 'label' => 'Terengganu'],
            'SB' => ['code' => '12', 'label' => 'Sabah'],
            'SR' => ['code' => '13', 'label' => 'Sarawak'],
            'WP' => ['code' => '14', 'label' => 'Wilayah Persekutuan Kuala Lumpur'],
            'LB' => ['code' => '15', 'label' => 'Wilayah Persekutuan Labuan'],
            'PJ' => ['code' => '16', 'label' => 'Wilayah Persekutuan Putrajaya'],
            'NA' => ['code' => '17', 'label' => 'Not Applicable'],
        ];
    }

    /**
     * Get seller ID type options
     */
    public static function get_seller_id_type_options() {
        return [
            'NRIC'     => 'NRIC',
     ...
     */
    public static function country_iso2_to_iso3($iso2) {
        $map = [
            'MY' => 'MYS',
            'SG' => 'SGP',
            'US' => 'USA',
    ...
    /**
     * Get tax category options
     */
    public static function get_tax_category_options() {
        return [
            //'01' => 'Sales Tax',
            '02' => 'Service Tax',
            //'03' => 'Tourism Tax',
    ...
    /**
     * Get MSIC codes array (hardcoded from LHDN SDK)
     * Source: https://sdk.myinvois.hasil.gov.my/files/MSICSubCategoryCodes.json
     */
    public static function get_msic_codes_array() {
        return [
            ...
            '47891' => 'Retail sale of books via stalls or markets',
            '47892' => 'Retail sale of carpets and rugs via stalls or markets',
    ...
    /**
     * Get MSIC code description by code
     */
    public static function get_msic_description($code) {
        $codes = self::get_msic_codes_array();
        return $codes[$code] ?? 'Other human health services n.e.c.';
    }
}
